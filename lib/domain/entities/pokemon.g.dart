...
int _pokemonEstimateSize(
  ...
  bytesCount += 3 + object.spriteFont.length * 3;
  return bytesCount;
}
...
void _pokemonSerialize(
  ...
  writer.writeString(offsets[2], object.spriteFont);
}
...
Pokemon _pokemonDeserialize(
  ...
  final object = Pokemon(
    ...
    spriteFont: reader.readString(offsets[2]),
  );
  return object;
}
...
extension PokemonQueryFilter
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'spriteFont',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'spriteFont',
        value: '',
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> spriteFontIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'spriteFont',
        value: '',
...
extension PokemonQuerySortBy on QueryBuilder<Pokemon, Pokemon, QSortBy> {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> sortBySpriteFont() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'spriteFont', Sort.asc);
    });
  }

  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> sortBySpriteFontDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'spriteFont', Sort.desc);
    });
  }
}
...
extension PokemonQuerySortThenBy
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> thenBySpriteFont() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'spriteFont', Sort.asc);
    });
  }

  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> thenBySpriteFontDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'spriteFont', Sort.desc);
    });
  }
...
extension PokemonQueryWhereDistinct
  ...
  QueryBuilder<Pokemon, Pokemon, QDistinct> distinctBySpriteFont(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'spriteFont', caseSensitive: caseSensitive);
    });
  }
}
...
extension PokemonQueryProperty
  ...
  QueryBuilder<Pokemon, String, QQueryOperations> spriteFontProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'spriteFont');
    });
  }
}
